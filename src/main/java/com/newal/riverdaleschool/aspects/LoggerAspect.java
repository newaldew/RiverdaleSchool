package com.newal.riverdaleschool.aspects;
...
public class LoggerAspect {
    ...
    @Around("execution(* com.newal.riverdaleschool..*.*(..))")
    ...
    @AfterThrowing(value = "execution(* com.newal.riverdaleschool.*.*(..))",throwing = "ex")
